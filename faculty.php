...
<div id="divcontainer">
	...
	<div style="text-align:center;border:0px solid #000;margin-left:0%;width:100%">
		<iframe src="inc/mainfooter/faculty.htm" style="width:100%;height:700px;overflow:none" frameborder="no"></iframe>
	</div>
